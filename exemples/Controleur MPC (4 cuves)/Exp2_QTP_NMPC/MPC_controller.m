classdef MPC_controller < matlab.System
    ...
    methods
        ...
        function [opti, x, x0, xref, u] = construct_problem(obj)
        ...
        % end
            ...
            opti.solver('ipopt',...
                        ...
                        struct('print_level', 0, 'max_iter', 100));
        ...
        % execution time TIME_EXEC is also returned.
            ...
            if obj.use_warm_start && ~isempty(obj.prev_sol)
                try
                    ...
                    % warm start failed silently – solver uses its default
                end
            end
